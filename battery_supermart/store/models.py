...
class Product(models.Model):
    ...
    price_with_old_battery = models.DecimalField(max_digits=10, decimal_places=2, blank=True)
    price_without_old_battery = models.DecimalField(max_digits=10, decimal_places=2, blank=True)
